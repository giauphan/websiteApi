            ...
            <div class="row">
                ...
                <div class="col-md-6 contents">
                    <div style="margin-top: 25%;" class="row justify-content-center shadow p-3 mb-5 bg-body rounded ">
                        <div class="col-md-8">
                            <div class="mb-4">
                                <h3>Forgot Password <strong> </strong></h3>
                            </div>
                            <form action="#" method="post">
                                ...
                                <!-- button -->
                                <input type="submit" style="background-color: purple;border:1px solid purple;height: 45px;" value="Reset Password" class="btn text-white btn-block btn-primary">
                                <hr>
                            </form>
                        </div>
                    </div>
